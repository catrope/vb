...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTBooldenotation(@SuppressWarnings("unused") TBooldenotation node)
    {
        this.index = 24;
    }

    @Override
    public void caseTChardenotation(@SuppressWarnings("unused") TChardenotation node)
    {
        this.index = 25;
    }
